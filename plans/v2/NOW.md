...
Two streams are active: Phase 5, with `P05-S008` selected, and
Phase 0B, with `P00B-T003` as its selected slice.

Next action: **build `P05-S008`** on a branch off `main`; its completion check is in the
table above. The phase exit review follows it.
