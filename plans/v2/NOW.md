...
Next action: **build `P06-S002b`** on `feat/v2-phase6-s002b`: first the renderer-deferred start
that unifies both paths, held by `P06-S002`'s oracles, then the live boundary's steal.
