...
Next action: **`P06-S003`**, per-note expression and the bend clause: ADR-0047 clause 9's
reserved per-note event, `SOUND-INV-021`'s bend as a cents offset after resolution, and the one
rule for what expression allocation, stealing, sustain, retrigger and release preserve or
clear — ADR-0058 clause 5 already makes expression addressed to a taken note an orphan.
