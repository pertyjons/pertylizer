...
bullets as corrected on 2026-09-05. Both decisions the review waited on are taken: the
legacy adapter is withdrawn by a correction of the phase plan, and the amplitude's smoothing
policy is carried as `P05-R001`.
