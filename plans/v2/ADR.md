...
| ADR-0047 | Note identity in the event contract          | Accepted | 3                     | [ADR](decisions/ADR-0047-note-identity-in-the-event-contract.md)   | Makes ADR-0046 clause 3's orphan-release sentence implementable. `SOUND-INV-017` is its contract; `HOST-INV-009` gained a third drop cause. Decides identity only; REV-P02's pitch and velocity limbs keep the Phase 3 owner and deadline REV-P02 gave them |
