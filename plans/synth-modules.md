...
This document is a catalog of all 71 synth modules and effects in Pertylizer, grouped by their category (`ModuleCategory`). It serves as a central reference mapping each module's Rust struct to its `ModuleType` identifier, implementation file, and a type safety check.
...
| Module | Type | File | Type Safety |
| :--- | :--- | :--- | :--- |
| [Oscillator](file:///home/per/github/pertylizer/crates/synth_modules/src/oscillator.rs) | `Oscillator` | [oscillator.rs](file:///home/per/github/pertylizer/crates/synth_modules/src/oscillator.rs) | ✅ (Refactored Phase chaining) |
...
| Module | Type | File | Type Safety |
| :--- | :--- | :--- | :--- |
| [Lfo](file:///home/per/github/pertylizer/crates/synth_modules/src/lfo.rs) | `Lfo` | [lfo.rs](file:///home/per/github/pertylizer/crates/synth_modules/src/lfo.rs) | ✅ (Refactored Phase chaining) |
