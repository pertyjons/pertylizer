...
pub use synth_osc_protocol::addresses::{
    ...
    ENGINE_RECORDED_NOTE_LOSSES, ENGINE_RT_ARC_DROPS, ENGINE_SEND_TRUNCATIONS,
    ENGINE_SEQ_BUFFER_GROWTHS, ENGINE_VOICE_COUNT, EVENT_CC, EVENT_NOTE_OFF, EVENT_NOTE_ON, META,
    META_FFT_FREQS, META_SEQ, TRANSPORT_PHASE, TRANSPORT_STATE, VIZ_CAMERA_MODE, VIZ_PING,
    VIZ_PONG,
};
