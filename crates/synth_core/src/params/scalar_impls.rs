...
use crate::params::{
    ...
    ReverseGateMode, ReverseGateTrigger, SampleId, SamplerPlayMode, SrcAddr, SubOscOctave,
    SubOscWaveform, TuringScale, Waveform, WaveshaperCurve, WavetableSelect,
};
use crate::types::{
...
scalar!(BeatDivision => Continuous, None, Linear);
