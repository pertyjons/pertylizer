...
impl GroupTemplateManager {
    ...
    /// - Linux: `~/.local/share/modular-synth/group-templates`
    /// - macOS: `~/Library/Application Support/modular-synth/group-templates`
    /// - Windows: `%APPDATA%\modular-synth\group-templates`
    ...
    pub fn default_templates_dir() -> Result<PathBuf, PatchError> {
        ...
        Ok(base.join("modular-synth").join("group-templates"))
    }
