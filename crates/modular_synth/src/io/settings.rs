...
//! - Linux: `~/.local/share/modular-synth/settings.json`
//! - macOS: `~/Library/Application Support/modular-synth/settings.json`
//! - Windows: `%APPDATA%\modular-synth\settings.json`
...
pub fn settings_path() -> Result<PathBuf, &'static str> {
    ...
    Ok(base.join("modular-synth").join("settings.json"))
}
