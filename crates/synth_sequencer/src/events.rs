...
use super::time::Tick;
use synth_core::{BipolarValue, Cents, NormalizedValue, VoiceIndex};
...
pub enum SequencerEvent {
    ...
    /// Per-tick modulation from tracker effects (vibrato, portamento, volume slide).
    ///
    /// Generated by `ChannelEffectProcessor::process_tick()` for each channel with
    /// active continuous effects.
    Modulation {
        /// Absolute position in the song.
        tick: Tick,
        /// Track/channel that generated this modulation.
        track: TrackId,
