...
pub fn patch_string_ensemble() -> Patch {
    ...
    patch.description = Some("Rich, orchestral string section with vibrato and hall reverb.".to_string());
    patch.notes = Some(r#"
SIGNAL FLOW:
...
"#.to_string());
    patch.tags = vec!["strings".into(), "orchestral".into(), "pad".into(), "ensemble".into()];
