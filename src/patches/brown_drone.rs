...
pub fn patch_brown_drone() -> Patch {
    ...
    patch.description = Some("Dark, rumbling ambient drone using brown noise filtering.".to_string());
    patch.notes = Some(r#"
SIGNAL FLOW:
...
"#.to_string());
    patch.tags = vec!["ambient".into(), "drone".into(), "noise".into(), "experimental".into(), "dark".into()];
