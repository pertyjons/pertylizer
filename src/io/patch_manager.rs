...
impl PatchManager {
    ...
    /// - Linux: `~/.local/share/modular-synth/patches`
    /// - macOS: `~/Library/Application Support/modular-synth/patches`
    /// - Windows: `%APPDATA%\modular-synth\patches`
    ...
    pub fn default_patches_dir() -> Result<PathBuf, PatchError> {
        ...
        Ok(base.join("modular-synth").join("patches"))
    }
